# Configuration
$orgName = "daradu"
$projectName = "dawr-demo"
$teamName = "T"
$adminGroupNameOrUserUpn = "[dawr-demo]\CustomTeamAdmin" # "radudanielro@yahoo.com" # "[Project]]\My Custom Group" # Valid formats "[ProjectName]\Group Name", "userid@domain.tld", "Collection Group Name"
$personalToken = "***" # Required scopes: vso.identity (read), vso.security_manage
